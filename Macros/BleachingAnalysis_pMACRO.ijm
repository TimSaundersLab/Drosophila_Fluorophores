...
function processFile(input, output, file) {
	...
	close();
	run("Bio-Formats Importer", "open=[" + input + File.separator + file + "] color_mode=Default rois_import=[ROI manager] specify_range view=Hyperstack stack_order=XYCZT z_begin=18 z_end=45 z_step=1");
